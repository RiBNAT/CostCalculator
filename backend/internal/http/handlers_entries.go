...
func (h *entryHandlers) buildExpense(c *gin.Context, uid, periodID string, req expenseReq) (*domain.Expense, bool) {
	...
	return &domain.Expense{
		UserID: uid, PeriodID: periodID, Date: date,
...
func (h *entryHandlers) createExpense(c *gin.Context) {
	...
	e, ok := h.buildExpense(c, uid, c.Param("id"), req)
	if !ok {
		return
	}
	e.ID = repo.NewID()
...
func (h *entryHandlers) buildTransfer(c *gin.Context, uid, periodID string, req transferReq) (*domain.Transfer, bool) {
	date, err := parseDay(req.Date)
	if err != nil {
		BadRequest(c, "invalid date, expected YYYY-MM-DD")
		return nil, false
...
func (h *entryHandlers) createTransfer(c *gin.Context) {
	...
	t, ok := h.buildTransfer(c, uid, c.Param("id"), req)
	if !ok {
		return
	}
	t.ID = repo.NewID()
