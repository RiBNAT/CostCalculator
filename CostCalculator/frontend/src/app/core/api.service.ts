...
export class ApiService {
  ...
  periodTrends(id: string): Observable<PeriodTrends> {
    return this.http.get<PeriodTrends>(`${base}/periods/${id}/trends`);
  }
  savingsHistory(): Observable<SavingsHistoryPoint[]> {
    return this.http.get<SavingsHistoryPoint[]>(`${base}/savings/history`);
  }
